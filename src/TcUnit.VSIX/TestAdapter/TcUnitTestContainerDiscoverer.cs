...
namespace TcUnit.VSIX
{

    [Export(typeof(ITestContainerDiscoverer))]
    public class ProtractorTestContainerDiscoverer : ITestContainerDiscoverer
    {
        public const string ExecutorUriString = TcUnit.TestAdapter.TestExecutor.ExecutorUriString;
        ...
        protected string FileExtension { get => TcUnit.TestAdapter.TestExecutor.FileExtension; }
        ...
        private void OnProjectItemChanged(object sender, TestFileChangedEventArgs e)
        {
            if (e != null)
            {
                // Don't do anything for files we are sure can't be test suite files
